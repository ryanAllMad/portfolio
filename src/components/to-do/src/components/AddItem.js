...
const onFormSubmit = (e) => {
    ...
    return (
        ...
        <form className="add-item-form" ref={formRef} onSubmit={onFormSubmit}>
            <label id="add-item-label" htmlFor="add-to-do">Add List Item:</label><br />
            <input name="add-to-do" type="text" ref={inputRef} value={item} onChange={onInputChange} id="add-to-do" placeholder="E.g. My first to do item" aria-invalid={valid} />
            <button type="submit"  disabled={disabled}>Add</button>
        </form>
        </fieldset>
        <fieldset>
        <legend>Items To Do</legend>
